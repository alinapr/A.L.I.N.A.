...
public class ProcessCompleteEvent extends ProcessEvent {
	public static final String MODEL_ID = "processEvent:processComplete";
	 ...
	 */
	public ProcessCompleteEvent(Map<String, Object> content) {
		super(content);
	}
	 ...
	 */
	public ProcessCompleteEvent(String id, String processId, String processInstanceId) {
